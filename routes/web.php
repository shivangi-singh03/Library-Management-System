...
Route::group(['middleware'=>'guard'],function()
{
    ...
    Route::put('book_update/{id}','BookController@update')->name('book_update');
    ...
    Route::put('student_update/{id}','StudentController@update')->name('student_update');
    ...
    Route::get('student/information','LogController@studentInformation');
});
